...
<div class="account-container lightbox-inner">
	...
	<div class="col2-set row row-large" id="customer_login">
			...
			<div class="account-register-inner">
				...
				<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						...
						<input type="email" class="woocommerce-Input woocommerce-Input--text input-text" name="email" id="reg_email" placeholder="Your email..."  autocomplete="email" value="<?php echo ( ! empty( $_POST['email'] ) ) ? esc_attr( wp_unslash( $_POST['email'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
					</p>
					...
					<?php else : ?>
						...
						<h6><?php esc_html_e( 'A password will be sent to your email address.', 'woocommerce' ); ?></h6>
