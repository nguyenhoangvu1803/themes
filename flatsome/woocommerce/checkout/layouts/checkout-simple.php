					...
					<div class="container">
						...
						<?php if(!get_theme_mod('check_out_hide_massage')) { ?>
							<div class="message-container right">
								<a href="https://flagwix.com/delivery-processing-delays-due-to-covid-19/">
									<svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right:7px;">
									...
									Delays in Shipping and COVID-19 Statement</a>
							</div>
						<?php }?>
					</div>
				</div>
