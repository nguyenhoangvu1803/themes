	...
	class MultiPostThumbnails {
		...
		public function enqueue_admin_scripts( $hook ) {
			...
			if (version_compare($wp_version, '3.5', '<')) {	
				...
				wp_enqueue_script( "mpt-featured-image", get_template_directory_uri() . '/assets/js/multi-post-thumbnails-admin.js' , array( 'jquery', 'set-post-thumbnail' ) );
				wp_enqueue_script( "mpt-featured-image-modal", get_template_directory_uri() . '/assets/js/media-modal.js' , array( 'jquery', 'media-models' ) );				
			}
