...
?>
  <style id="uoy-custom-css" type="text/css">
      ...
      ?>
          /* COLOR */
          .color-primary, .fl-wrap.fl-is-active>label[for]:first-child, .fl-wrap.fl-has-focus>label[for]:first-child, form .woocommerce-form-row:hover label, a.lost_password, .lost_password a, .nav-right>li.cart-item>a, .product-info .posted_in a, ul.product-tabs li > a
